...
val detektAll by tasks.registering(Detekt::class) {
    ...
    reports {
        ...
        xml.required.set(true)
        xml.outputLocation.set(file("build/reports/detekt-all.xml"))
        html.required.set(true)
        html.outputLocation.set(file("build/reports/detekt-all.html"))
        sarif.required.set(true)
        sarif.outputLocation.set(file("build/reports/detekt-all.sarif"))
        txt.required.set(true)
        txt.outputLocation.set(file("build/reports/detekt-all.txt"))
        md.required.set(true)
        md.outputLocation.set(file("build/reports/detekt-all.md"))
    }
