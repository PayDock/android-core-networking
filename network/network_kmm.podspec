Pod::Spec.new do |spec|
    ...
    spec.vendored_frameworks      = 'build/cocoapods/framework/network_kmm.framework'
    spec.libraries                = 'c++'
    spec.ios.deployment_target    = '16.0'
                
                
    if !Dir.exist?('build/cocoapods/framework/network_kmm.framework') || Dir.empty?('build/cocoapods/framework/network_kmm.framework')
        raise "

        Kotlin framework 'network_kmm' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :network-kmm:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':network-kmm',
        'PRODUCT_MODULE_NAME' => 'network_kmm',
    }
                
    spec.script_phases = [
        {
            :name => 'Build network_kmm',
